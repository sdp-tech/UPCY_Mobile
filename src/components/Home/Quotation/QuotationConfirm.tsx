...
<View style={{position: 'absolute', width: '100%', height: '100%', backgroundColor: 'white', opacity: 0.9}} />
        ...
        <View style={{marginTop: 20}}>
          ...
          <Title20B style={{color: BLACK, marginBottom: 3, textAlign: 'center'}}>마켓명 (SDP의 상점)</Title20B>
       ...
       <View style={{ flexDirection: 'row', justifyContent: 'space-around', padding: 10 }}>
           ...
           >
              ...
              <TouchableOpacity
                style={{ backgroundColor: '#F4F4F4', padding: 10, flex: 1, marginLeft: 10,marginRight: 30, alignItems: 'center', borderRadius: 20, }}
